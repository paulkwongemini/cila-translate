...
스크립트 실행 명령:
```bash
python3 scripts/get_verse.py --book "<Book Name>" --chapter <Chapter> --verse <Verse(s)>
```
...
```bash
# 요한복음 3:16
python3 scripts/get_verse.py --book "John" --chapter 3 --verse 16

# 창세기 1:1-3
python3 scripts/get_verse.py --book "Genesis" --chapter 1 --verse 1-3

# 마태복음 5장 3,5,7절
python3 scripts/get_verse.py --book "Matthew" --chapter 5 --verse 3,5,7
```
