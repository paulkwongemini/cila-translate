...
```bash
python3 ${CLAUDE_SKILL_DIR}/scripts/update_attendance.py --read-only
```
...
```bash
python3 ${CLAUDE_SKILL_DIR}/scripts/update_attendance.py --dry-run
```
...
```bash
python3 ${CLAUDE_SKILL_DIR}/scripts/update_attendance.py
```
